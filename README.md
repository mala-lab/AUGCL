...
Pytorch implementation for the paper "Affinity Uncertainty-based Hard Negative Mining in Graph Contrastive Learning"([Paper](https://arxiv.org/pdf/2301.13340.pdf)&[Appendix](https://github.com/mala-lab/AUGCL/blob/main/Appendix.pdf))".
